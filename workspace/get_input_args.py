...
def get_input_args():
    ...
    # Path to CNN Model Architecture
    parser.add_argument('--arch', type = str, default = 'vgg', 
                    help = 'path to the CNN Model Architecture') 
    # Path to Text File with Dog Names 
    ...
    in_args = parser.parse_args() # Assign variable in_args to parse_args()
    # Access the 3 command line arguments as specified above by printing them
